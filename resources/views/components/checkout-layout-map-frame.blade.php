...
<div class="pointer-events-auto mb-3 flex flex-wrap items-center justify-center gap-2 rounded-lg border border-fuchsia-900/50 bg-black/50 px-2 py-2 text-white shadow-inner">
...
<div x-ref="layoutViewport"
     ...
     class="pointer-events-auto relative w-full min-h-[200px] max-h-[min(78dvh,900px)] touch-manipulation overflow-auto overscroll-contain rounded-xl border border-fuchsia-900/40 bg-[radial-gradient(circle,_rgba(255,255,255,0.12)_1px,_transparent_1px)] bg-[size:16px_16px] p-2 sm:max-h-[min(86vh,90dvh)]">
