...
<nav class="sticky top-20 z-50 -mx-4 mb-6 flex items-center border-b border-purple-900/40 bg-black/90 px-4 py-3 backdrop-blur sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8"
     aria-label="Navegación del mapa de butacas">
    <a href="{{ $backUrl ?? route('seller.events.index') }}"
       class="relative z-50 inline-flex items-center gap-2 rounded-lg border border-purple-800/60 bg-black/80 px-4 py-2 text-sm font-semibold text-[#ff2daa] transition hover:bg-purple-950/50 hover:text-[#39ff14] pointer-events-auto">
