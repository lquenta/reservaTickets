...
<div class="max-w-2xl mx-auto mb-6 sm:mb-8 px-1">
    <a href="{{ route($flow->checkoutSuccessRoute) }}" class="text-sm text-[#e50914] hover:text-red-400">← Volver a eventos</a>
</div>
...
<div class="max-w-2xl mx-auto px-1" x-data="checkoutTimer({{ $reservation->expires_at->timestamp * 1000 }})" x-init="start()">
    ...
    <div class="rounded-2xl border border-red-900/50 bg-black/60 backdrop-blur px-4 py-6 sm:p-8 md:p-10 space-y-8">
        ...
        <div class="rounded-2xl border-2 border-[#e50914]/60 bg-[#e50914]/10 p-6">
            <h2 class="font-display text-xl font-bold text-[#e50914] tracking-wider mb-4">ENTRADAS DEL CLIENTE</h2>
            <ul class="space-y-3">
