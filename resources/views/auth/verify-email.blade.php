...
<div class="max-w-md mx-auto">
    <div class="rounded-2xl border border-red-900/50 bg-black/60 backdrop-blur p-8 md:p-10 text-center">
        <h1 class="font-display text-2xl font-bold text-[#e50914] tracking-widest mb-4">VERIFICA TU CORREO</h1>
        ...
        <form method="POST" action="{{ route('verification.send') }}" class="mb-4">
            @csrf
            <button type="submit" class="w-full rounded-xl bg-[#e50914] px-5 py-3 text-white font-bold hover:bg-red-600 transition">
