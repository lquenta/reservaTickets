...
<head>
    ...
    <style>
        ...
        .ticket-title { font-size: 18px; font-weight: bold; color: #e11d8a; border-bottom: 1px solid #f9a8d4; padding-bottom: 12px; margin: 0 0 8px 0; }
        ...
        .ticket-seat-value { font-family: monospace; color: #e11d8a; }
