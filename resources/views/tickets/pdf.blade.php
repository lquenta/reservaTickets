...
<head>
    ...
    <style>
        ...
        .ticket { border: 2px solid #a569ff; border-radius: 16px; padding: 24px 28px; margin: 16px 0; background: #fff; page-break-inside: avoid; max-width: 400px; }
        .ticket-title { font-size: 18px; font-weight: bold; color: #ff2daa; border-bottom: 1px solid #a569ff; padding-bottom: 12px; margin: 0 0 8px 0; }
        ...
        .ticket-seat-value { font-family: monospace; color: #ff2daa; }
