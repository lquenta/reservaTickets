...
<div class="mb-8 flex flex-wrap items-center justify-between gap-4">
    ...
    <div class="flex flex-wrap gap-2">
        <a href="{{ route('admin.team-members.create') }}" class="rounded-xl bg-[#ff2daa] hover:bg-pink-600 px-5 py-2.5 text-white font-semibold transition">
            + Añadir uno
        </a>
...
<div class="rounded-2xl border-2 border-violet-200/60 dark:border-violet-700/50 bg-white dark:bg-slate-800/80 overflow-hidden shadow-lg">
    ...
    <div class="p-6" id="team-members-sortable">
        ...
        @empty
            <p class="py-12 text-center text-slate-500 dark:text-slate-400">No hay integrantes. <a href="{{ route('admin.team-members.create') }}" class="text-[#ff2daa] hover:underline">Añade el primero</a> para que aparezcan en la sección Quiénes somos.</p>
        @endforelse
    </div>
</div>
