...
<div class="max-w-2xl mx-auto mb-6">
    <a href="{{ route($flow->checkoutSuccessRoute) }}" class="text-sm {{ $isSellerLayout ? 'text-[#ff2daa] hover:text-[#39ff14]' : 'text-violet-600 dark:text-violet-400 hover:underline' }}">← Volver</a>
