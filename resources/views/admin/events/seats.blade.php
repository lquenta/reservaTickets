...
<div class="mb-8">
    <a href="{{ route('admin.events.index') }}" class="inline-flex items-center gap-2 text-white/70 hover:text-[#ff2daa] font-medium transition mb-4">
        &larr; Volver a eventos
    </a>
    <h1 class="font-display text-2xl sm:text-3xl font-bold text-[#ff2daa] tracking-widest">Butacas del evento</h1>
