...
<div class="space-y-6">
    ...
    <div class="grid sm:grid-cols-2 xl:grid-cols-3 gap-4">
        ...
        <div class="rounded-xl border border-violet-200/60 dark:border-violet-700/50 p-4 bg-white dark:bg-slate-800/80"><p class="text-xs uppercase text-slate-500">Ventas brutas</p><p class="text-2xl font-bold text-slate-800 dark:text-white">{{ number_format($metrics['kpis']['sales_total'], 2) }}</p></div>
        <div class="rounded-xl border border-orange-200/60 dark:border-orange-700/50 p-4 bg-white dark:bg-slate-800/80"><p class="text-xs uppercase text-slate-500">Reembolsos</p><p class="text-2xl font-bold text-slate-800 dark:text-white">{{ number_format($metrics['kpis']['refunds_total'], 2) }}</p></div>
        <div class="rounded-xl border border-emerald-200/60 dark:border-emerald-700/50 p-4 bg-white dark:bg-slate-800/80"><p class="text-xs uppercase text-slate-500">Ventas netas</p><p class="text-2xl font-bold text-slate-800 dark:text-white">{{ number_format($metrics['kpis']['net_sales'], 2) }}</p></div>
