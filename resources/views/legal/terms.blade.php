...
<div class="max-w-3xl mx-auto">
    <div class="rounded-2xl border border-fuchsia-900/50 bg-black/60 backdrop-blur p-8 md:p-10">
        <h1 class="font-display text-3xl font-bold text-[#e11d8a] tracking-widest mb-2">TÉRMINOS Y CONDICIONES</h1>
        ...
        <div class="prose prose-invert prose-red max-w-none space-y-8 text-white/90 text-sm leading-relaxed">
            <section>
                <h2 class="text-lg font-semibold text-[#e11d8a] mb-2">1. Objeto y aceptación</h2>
            ...
            <section>
                <h2 class="text-lg font-semibold text-[#e11d8a] mb-2">2. Reserva de entradas</h2>
            ...
            <section>
                <h2 class="text-lg font-semibold text-[#e11d8a] mb-2">3. Deslindamiento de responsabilidad</h2>
            ...
            <section>
                <h2 class="text-lg font-semibold text-[#e11d8a] mb-2">4. Protección de datos y ciberseguridad</h2>
            ...
            <section>
                <h2 class="text-lg font-semibold text-[#e11d8a] mb-2">5. Uso aceptable del Sitio</h2>
            ...
            <section>
                <h2 class="text-lg font-semibold text-[#e11d8a] mb-2">6. Propiedad intelectual</h2>
            ...
            <section>
                <h2 class="text-lg font-semibold text-[#e11d8a] mb-2">7. Modificaciones</h2>
            ...
            <section>
                <h2 class="text-lg font-semibold text-[#e11d8a] mb-2">8. Ley aplicable y resolución de conflictos</h2>
            ...
            <section>
                <h2 class="text-lg font-semibold text-[#e11d8a] mb-2">9. Contacto</h2>
        ...
        <div class="mt-10 pt-6 border-t border-fuchsia-900/50">
            <a href="{{ url()->previous() }}" class="inline-flex items-center gap-2 text-[#e11d8a] hover:text-[#22d3ee] transition font-medium">
